  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        {latestWorkout && (
          <div className="container mt-4" style={{ flexBasis: '45%', padding: '1rem', border: '1px solid #ccc', borderRadius: '8px', marginRight: '0.5rem', background: '#ffffff' }}>
        ...
        {oldestWorkout && (
          <div className="container mt-4" style={{ flexBasis: '45%', padding: '1rem', border: '1px solid #ccc', borderRadius: '8px', marginLeft: '0.5rem', background: '#ffffff' }}>
